...
<body style = "padding: 60px;">
	...
	<div class = "content" align = "center" style = "margin-left: 250px;margin-right: 250px;">
		...
		<%} } %>
		<hr>
		<p class= "text-left"> <b>给当前论文添加讨论 : </b>  </p>
		<form class="form-group" method="post" action="SetDiscuss?paper_number=<%=paper.getPaper_number() %>&pc_code=<%=member.getPc_code() %>">
        	<div class="form-group">
            	<textarea name="comments" class="form-control" row="5" > </textarea>
          	</div>
          	<div class="form-group">
      			<button type="submit" class="btn btn-default">添加讨论</button>
  			</div>
    	</form>
	</div>
</body>
